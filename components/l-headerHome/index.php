<header class="l-headerHome">
    ...
    <div class="l-headerHome__hero">
        <div class="l-headerHome__controls">
            <ul class="l-headerHome__controls__arrows" data-aos="fade-right">
                <li>
            ...
            <div class="l-headerHome__controls__dots" data-aos="fade-right">
        ...
        <div class="l-headerHome__slider">
            <div class="l-headerHome__slider__wrapper swiper-wrapper">
                ...
                <div class="l-headerHome__slider__item swiper-slide">
                    ...
                    <div class="l-headerHome__slider__item__content" data-aos="fade-up">
        ...
        <div class="l-headerHome__scroll" data-aos="fade-up">
            <div class="u-container">
                <?php
                $cScrollLink = array(
                    "modifiers" => "--movaOrto",
